...
insert into restaurantes (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (2, 'Thai Delivery',        9.50, 1, TO_TIMESTAMP(1715068800000  / 1000), TO_TIMESTAMP(1715068800000  / 1000));

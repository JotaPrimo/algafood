...
insert into restaurantes (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (2, 'Thai Delivery',        9.50, 1, NOW() AT TIME ZONE 'UTC', NOW() AT TIME ZONE 'UTC');
insert into restaurantes (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (3, 'Tuk Tuk Comida Indiana', 15, 2, NOW() AT TIME ZONE 'UTC', NOW() AT TIME ZONE 'UTC');
insert into restaurantes (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (4, 'Java Steakhouse', 12, 3, NOW() AT TIME ZONE 'UTC', NOW() AT TIME ZONE 'UTC');
insert into restaurantes (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (5, 'Lanchonete do Tio Sam', 11, 4, NOW() AT TIME ZONE 'UTC', NOW() AT TIME ZONE 'UTC');
insert into restaurantes (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (6, 'Bar da Maria', 6, 4, NOW() AT TIME ZONE 'UTC', NOW() AT TIME ZONE 'UTC');
